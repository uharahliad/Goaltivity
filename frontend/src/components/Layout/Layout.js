        ...
        <div className={classes.root}>
            ...
            >
                ...
                <Switch>
                    ...
                    <Route path={"/admin/goals/:id/edit"} exact component={GoalsFormPage} />

                    <Route path={"/admin/goal_categories"} exact component={Goal_categoriesTablePage} />
                    <Route path={"/admin/goal_categories/new"} exact component={Goal_categoriesFormPage} />
                    <Route path={"/admin/goal_categories/:id/edit"} exact component={Goal_categoriesFormPage} />

                    <Route path={"/admin/success_criteria"} exact component={Success_criteriaTablePage} />
                    <Route path={"/admin/success_criteria/new"} exact component={Success_criteriaFormPage} />
                    <Route path={"/admin/success_criteria/:id/edit"} exact component={Success_criteriaFormPage} />

                    <Route path={"/admin/action_items"} exact component={Action_itemsTablePage} />
                    <Route path={"/admin/action_items/new"} exact component={Action_itemsFormPage} />
                    <Route path={"/admin/action_items/:id/edit"} exact component={Action_itemsFormPage} />

                    <Route path={"/admin/accountability_groups"} exact component={Accountability_groupsTablePage} />
                    <Route path={"/admin/accountability_groups/new"} exact component={Accountability_groupsFormPage} />
                    <Route path={"/admin/accountability_groups/:id/edit"} exact component={Accountability_groupsFormPage} />
                    ...
                    <Route path={"/admin/messages/:id/edit"} exact component={MessagesFormPage} />
