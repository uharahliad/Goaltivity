...
const MessagesTable = () => {
  ...
  const [filters, setFilters] = React.useState([
    {label: 'Text', title: 'text'},
          ...
          {label: 'Author', title: 'author'},{label: 'Group', title: 'group'},
  ]);
  ...
  const columns = [
      ...
      { field: "group",
        ...
        sortable: false,
        renderCell: (params) => accountability_groupsDataFormat.listFormatter(params.row[params.field], history, 'accountability_groups'),
        flex: 1,
...

      {
        ...
        flex: 0.6,
        maxWidth: 80,
        renderCell: (params) => <Actions classes={classes} entity="messages" openModal={openModal} {...params} />,
      }
  ];
      ...
      <Widget title={<h4>{humanize('Messages')}</h4>} disableWidgetMenu>
        ...
        <div style={{minHeight: 500, width: "100%", paddingTop: 20, paddingBottom: 20}}>
          <DataGrid
            ...
            disableColumnMenu
            loading={loading}
            onRowClick={(e) => {history.push(`/admin/messages/${e.id}/edit`)}}
            autoHeight
          />
        </div>
